/*
 FullScreenButton.tsx - ESP3D WebUI component file
...
const FullScreenButton: FunctionalComponent<FullScreenButtonProps> = ({ elementId, hideOnFullScreen, asButton, onclick }) => {
    ...
    function setFullScreenMode(value: boolean) {
    ...
    const commonProps = {
        icon: isFullScreenMode ? <Minimize style={{ width: "0.8rem", height: "0.8rem" }} /> : <Maximize style={{ width: "0.8rem", height: "0.8rem" }} />,
        m1: true,
    }
