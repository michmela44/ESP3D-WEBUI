...
type ModalComponent = ReturnType<typeof createComponent> & {
    Overlay: ReturnType<typeof createComponent>
    Container: ReturnType<typeof createComponent>
    Header: ReturnType<typeof createComponent>
    Body: ReturnType<typeof createComponent>
    Footer: ReturnType<typeof createComponent>
}

const Modal = createComponent("div", "modal", modifiers) as ModalComponent
