/*
 eventBus.ts - ESP3D WebUI hooks file
...
class EventBus {
    ...
    // Listener
    on<T = any>(event: string, callback: (data: T) => void, id: string | number | null = null): string | number {
    ...
    off(event: string, id: string | number): void {
